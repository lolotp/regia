<div class="bs-callout bs-callout-danger">
 ...
 <ol>
   ...
   <li> Update the connection parameters for the database in the <code>regia.db.schema</code> namespace of your application.
...
Two middleware functions are provided by default in the `regia.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `regia.handler` namespace to manage the enabled middleware.
